...
from . import edit_or_reply, mention, zedub
    ...
    if query.startswith("الاوامر") and event.query.user_id == zedub.uid:
        buttons = [
            ...
            [
                ...
                Button.inline("⓯", data="ahmad15"),
            ],
            [
                Button.inline("⓰", data="ahmad16"),
                Button.inline("⓱", data="ahmad17"),
            ],
            [
                Button.inline("⓲", data="ahmad18"),
                Button.inline("⓳", data="ahmad19"),
                Button.inline("⓴", data="ahmadd20"),
            ],
        ]
        result = builder.article(
            title="zedub", text=Malath, buttons=buttons, link_preview=False
        )
...
async def zed(event):
    await edit_or_reply(
        event,
        "[ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الـخدمــات العـامــه 🎡](t.me/ZThon) .\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n⪼ `.مساعده`\n\n⪼ `.اوامر الفارات`\n\n⪼ `.اوامر السوبر`\n\n⪼ `.اوامر النشر`\n\n⪼ `.الترحيب`\n\n⪼ `.الردود`\n\n⪼ `.الاذاعه`\n\n⪼ `.التكرار`\n\n⪼ `.المساعد`\n\n⪼ `.الطقس`\n\n\n 𓆩 [𝗭𝗧𝗵𝗼𝗻 𝗨𝘀𝗲𝗿𝗯𝗼𝘁](t.me/ZThon) 𓆪",
    )
...
async def zed_handler(event):
    ...
    if query.startswith("اليدوي") and event.query.user_id == zedub.uid:
        ...
        result = builder.article(
            title="zedub", text=zelzal, buttons=buttons, link_preview=False
        )
        await event.answer([result] if result else None)
